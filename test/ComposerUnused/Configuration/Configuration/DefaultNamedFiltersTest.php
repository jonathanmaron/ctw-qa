...
final class DefaultNamedFiltersTest extends TestCase
{
    ...
    /**
     * Test that invocation returns exactly two package names, pinning the curated filter count.
     */
    public function testInvokeReturnsExactlyTwoPackages(): void
    {
        $actual = ($this->defaultNamedFilters)();
    ...
    /**
     * Test that invocation includes Composer Unused itself, which is only ever run as a console binary.
     */
    public function testInvokeIncludesComposerUnused(): void
    {
        $actual = ($this->defaultNamedFilters)();

        self::assertContains('icanhazstring/composer-unused', $actual);
    }
